...
func NormalizeStatus(raw string) string {
	...
	// The state machine remains authoritative. These Turkish aliases are a
	// compatibility fallback for localized tracker rows not yet represented in
...
// notes unchanged.
func UpdateApplicationStatusAndNotes(careerOpsPath string, app model.DashboardRow, newStatus, notesAppend string) error {
	if !app.IsTrackedApplication() {
