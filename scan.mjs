...
// bounded without marking deferred postings as seen; future scans continue
...
export function prioritizeScanOffers(offers) {
  return offers
    ...
    .sort((left, right) => {
      const priority = parseScanPriority(right.offer?.scanPriority) - parseScanPriority(left.offer?.scanPriority);
